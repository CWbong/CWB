...
plt.imshow(Data_norm_test[10,:,:,0],cmap ='gray')
plt.show()
...
def BlackBoxFn(batch_size1, decay_rate1, decay_steps1, epochs1, features, initial_learning_rate1):
    ...
    BO_scores = -1*hist_Mono.history['val_loss'][-1]
    print(BO_scores)

    return BO_scores

pbounds = {'features': (60, 600),
           'initial_learning_rate1': (0.00001, 0.1),
           'batch_size1': (4, 32),
           'decay_steps1': (0.1, 10),
           'decay_rate1': (0.5, 0.96),
           'epochs1': (5, 30)}
...
search_num = 100
for i in range(search_num): # Now 'i' is the number of iteration to serach
