...
eq = 0.95
num = 50
checkpoint_path_Q = "F:/반응유동/코드/Ali/0204/2024_Final_Q982_0219/2024_Final_Q982_0219\\cp.ckpt"

model_Q =  tf.keras.models.load_model(checkpoint_path_Q)
model_Q.summary()
combined_model = model_Q
...
plt.colorbar()
#plt.clim(-0.25, 0.13)
plt.savefig('0220grad_ram' + str(fr)+'_'+str(eq)+'_'+'.tiff', format='tiff', dpi = 300)
plt.show()
